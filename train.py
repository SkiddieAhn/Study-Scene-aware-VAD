...
def main():
    ...
    parser.add_argument('--iters', default=30000, type=int, help='The total iteration number.')
    ...
    parser.add_argument('--video_length', default=10, type=int, help='number of positive video samples')
